...
PRIMARY KEY(carrier_id)  ,
  FOREIGN KEY Carrier(carrier_id)
...
PRIMARY KEY(date_, client_source_id)  ,
  FOREIGN KEY Client Source(client_source_id)
...
CREATE TABLE state (
  ...
  name TEXT   NOT NULL   ,
PRIMARY KEY(id)  ,
  FOREIGN KEY Country(country_id)
...
PRIMARY KEY(id)          ,
  FOREIGN KEY Backend(backend_id)
    REFERENCES backend(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Queue(queue_to)
    REFERENCES air_source(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Balance link(balance_link)
    REFERENCES air_source(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Currency(currency_id)
...
PRIMARY KEY(permission_id, user_type_id)    ,
  FOREIGN KEY Permission(permission_id)
    REFERENCES permission(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY User Type(user_type_id)
...
PRIMARY KEY(carrier_id, airport_id, is_domestic)    ,
  FOREIGN KEY Carrier(carrier_id)
    REFERENCES carrier(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Airport(airport_id)
...
PRIMARY KEY(id)    ,
  FOREIGN KEY Air Source(air_source_id)
    REFERENCES air_source(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Queue To(queue_to)
    REFERENCES air_source(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE);
...
PRIMARY KEY(id)      ,
  FOREIGN KEY Airline(carrier_id)
    REFERENCES carrier(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Service Type(service_type_id)
...
PRIMARY KEY(source_id, destination_id, carrier_id)      ,
  FOREIGN KEY Destination(destination_id)
    REFERENCES airport(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Origin(source_id)
    REFERENCES airport(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Carrier(carrier_id)
...
PRIMARY KEY(id)        ,
  FOREIGN KEY Airline(carrier_id)
    REFERENCES carrier(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Service(service_type_id)
    REFERENCES service_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Client Source(client_source_id)
...
CREATE TABLE routes_cache (
  ...
  order_ TINYINT  DEFAULT 11 NOT NULL ,
  grouping BIGINT      ,
PRIMARY KEY(id)                ,
  FOREIGN KEY Carrier(carrier_id)
    REFERENCES carrier(id)
  ...
  FOREIGN KEY Service type(service_type_id)
    REFERENCES service_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Traveler Type(traveler_type_id)
    REFERENCES traveler_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Origin(origin_id)
    REFERENCES airport(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Destination(destination_id)
...
PRIMARY KEY(plan_id, rule_id)    ,
  FOREIGN KEY Rules list(plan_id)
    REFERENCES commercial_plan(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Rule(rule_id)
...
PRIMARY KEY(id)        ,
  ...
  FOREIGN KEY Currency(currency_id)
    REFERENCES currency(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Commercial(commercial_plan_id)
    REFERENCES commercial_plan(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE);
...
PRIMARY KEY(id)          ,
  FOREIGN KEY City(city_id)
    REFERENCES city(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Passport Country(passport_country_id)
    REFERENCES country(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Gender(gender_id)
    REFERENCES gender(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY User Info(user_info_id)
    REFERENCES user_info(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Title(traveler_title_id)
...
PRIMARY KEY(type_id, user_info_id)  ,
  FOREIGN KEY Company(user_info_id)
    REFERENCES user_info(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE);
...
PRIMARY KEY(id)    ,
  FOREIGN KEY Traveler(traveler_id)
    REFERENCES traveler(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY docType(doc_type_id)
...
PRIMARY KEY(reseller_id)    ,
  FOREIGN KEY Distributor(distributor_id)
    REFERENCES user_info(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Reseller(reseller_id)
    REFERENCES user_info(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE);
...
PRIMARY KEY(id)      ,
  FOREIGN KEY City(city_id)
    REFERENCES city(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Corporate info(user_info_id)
    REFERENCES user_info(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE);
...
CREATE TABLE log (
  ...
  new_value TEXT      ,
PRIMARY KEY(id)    ,
  FOREIGN KEY Operation(operation_id)
...
PRIMARY KEY(ff_carriers_id, traveler_id)    ,
  FOREIGN KEY Promotions(ff_carriers_id)
...
CREATE TABLE visa (
  ...
  type TEXT      ,
PRIMARY KEY(id)    ,
  FOREIGN KEY country(issuing_country_id)
    REFERENCES country(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Traveler(traveler_id)
...
PRIMARY KEY(id)      ,
  FOREIGN KEY Creator(creator_id)
    REFERENCES users(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Approver(approver_id)
    REFERENCES users(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE);
...
PRIMARY KEY(id)        ,
  ...
  FOREIGN KEY Carrier(carrier_id)
    REFERENCES carrier(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Category(service_category_id)
...
PRIMARY KEY(id)      ,
  ...
  FOREIGN KEY Carrier(carrier_id)
    REFERENCES carrier(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY AirSource(air_source_id)
    REFERENCES air_source(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE);
...
PRIMARY KEY(id)      ,
  FOREIGN KEY Traveler(traveler_id)
    REFERENCES traveler(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY int_meal(int_meal_id)
    REFERENCES meal_list(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY itn_seat(int_seat_id)
...
CREATE TABLE air_cart (
  ...
  note TEXT      ,
PRIMARY KEY(id)            ,
  FOREIGN KEY Payment status(payment_status_id)
  ...
  FOREIGN KEY User(user_id)
    REFERENCES users(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Loged user(loged_user_id)
    REFERENCES users(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Status(booking_status_id)
    REFERENCES booking_status(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Approval Status(approval_status_id)
    REFERENCES approval_status(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY ClientSource(client_source_id)
    REFERENCES client_source(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE);
...
CREATE TABLE pay_gate_log (
  ...
  reason TEXT      ,
PRIMARY KEY(id)              ,
  FOREIGN KEY CC(cc_id)
    REFERENCES cc(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY PG(pg_id)
  ...
  FOREIGN KEY User Info(user_info_id)
    REFERENCES user_info(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Status(status_id)
    REFERENCES tr_status(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY AirCart(air_cart_id)
...
PRIMARY KEY(id)              ,
  ...
  FOREIGN KEY User(user_id)
    REFERENCES users(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Transfer type(transfer_type_id)
  ...
  FOREIGN KEY Distributor(distributor_id)
    REFERENCES user_info(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Pay gate log(pay_gate_log_id)
...
PRIMARY KEY(id)                            ,
  ...
  FOREIGN KEY Traveler type(traveler_type_id)
    REFERENCES traveler_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Booking Type(booking_type_id)
    REFERENCES booking_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Cabin type(cabin_type_id)
    REFERENCES cabin_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Cart(air_cart_id)
    REFERENCES air_cart(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Fare(fare_type_id)
  ...
  FOREIGN KEY Service(service_type_id)
    REFERENCES service_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY S.Request(special_request_id)
    REFERENCES special_request(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Payment process(payment_process_id)
  ...
  FOREIGN KEY AirSource(air_source_id)
    REFERENCES air_source(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY AB Status(ab_status_id)
...
CREATE TABLE aircart_file (
  ...
  name TEXT   NOT NULL   ,
PRIMARY KEY(id)  ,
  FOREIGN KEY AirCart(aircart_id)
    REFERENCES air_cart(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE);
...
PRIMARY KEY(cache_id, search_id)      ,
  FOREIGN KEY Search(search_id)
    REFERENCES searches(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Cache(cache_id)
...
CREATE INDEX PRIMARY ON search_x_cache (cache_id, search_id);
...
CREATE TABLE process (
  ...
  air_source_id INTEGER    ,
  searches_id INTEGER    ,
  queued TIMESTAMP  DEFAULT now() NOT NULL ,
  started TIMESTAMP    ,
  ended TIMESTAMP    ,
  result SMALLINT    ,
  note TEXT    ,
  ...
  command TEXT      ,
PRIMARY KEY(id)    ,
  FOREIGN KEY Search(searches_id)
    REFERENCES searches(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Air Source(air_source_id)
...
PRIMARY KEY(id)    ,
  FOREIGN KEY CC(cc_id)
    REFERENCES cc(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Transaction(pay_gate_log_id)
    REFERENCES pay_gate_log(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE);
...
CREATE TABLE cc_passtru (
  ...
  scope SMALLINT  DEFAULT 1 NOT NULL   ,
PRIMARY KEY(id)      ,
  FOREIGN KEY UserInfo(user_info_id)
    REFERENCES user_info(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE,
  FOREIGN KEY Cc(cc_id)
...
CREATE TABLE deposit_search (
  ...
  status_id SMALLINT  DEFAULT 1 NOT NULL   ,
PRIMARY KEY(id)        ,
  FOREIGN KEY Payment(payment_id)
...
PRIMARY KEY(id)        ,
  ...
  FOREIGN KEY Destination(destination_id)
    REFERENCES airport(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Booking(air_booking_id)
...
PRIMARY KEY(id)                ,
  FOREIGN KEY Loged user(loged_user_id)
    REFERENCES users(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Status(amendment_status_id)
    REFERENCES amendment_status(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Type(amendment_type_id)
    REFERENCES amendment_type(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Invoice status(invoice_status_id)
  ...
  FOREIGN KEY Booking(air_booking_id)
    REFERENCES air_booking(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY Air Route(air_route_id)
