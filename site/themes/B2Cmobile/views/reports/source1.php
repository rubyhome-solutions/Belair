                        ...
                        <div class="ibox-content">
                            ...
                            <div class="col-lg-12 padd-4"> 
                               ...
                               <div class="col-lg-12 box_co6">Ratios</div>
                                <div class="col-lg-12 inner">&nbsp;</div>
                                <div class="col-lg-12 inner inner2">S/R%</div>
                                ...
                                <div class="col-lg-4 remove-data"><span class="rado-h">S/R</span> <?php echo $td=getRatio($data['redirectdom'],$data['searchesdom']); ?>%</div>
                            ...
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                ...
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B</span> <?php echo $td=getRatio($data['bookingsdom'],$data['redirectdom']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['bookingsdom'],$prevdata['redirectdom']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B-Mob</span> <?php echo $td=getRatio($data['bookingsmobiledom'],$data['redirectmobiledom']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['bookingsmobiledom'],$prevdata['redirectmobiledom']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B-Web</span> <?php echo $td=getRatio(($data['bookingsdom']-$data['bookingsmobiledom']),($data['redirectdom']-$data['redirectmobiledom'])); ?>%</div>
                               ...
                               <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                ...
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">S/R</span> <?php echo $td=getRatio($data['redirectint'],$data['searchesint']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['redirectint'],$prevdata['searchesint']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B</span><?php echo $td=getRatio($data['bookingsint'],$data['redirectint']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['bookingsint'],$prevdata['redirectint']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B-Mob</span><?php echo $td=getRatio($data['bookingsmobileint'],$data['redirectmobileint']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['bookingsmobileint'],$prevdata['redirectmobileint']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B-Web</span> <?php echo $td=getRatio(($data['bookingsint']-$data['bookingsmobileint']),($data['redirectint']-$data['redirectmobileint'])); ?>%</div>
                                ...
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">S/R</span><?php echo $td=getRatio($data['redirect'],$data['searches']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['redirect'],$prevdata['searches']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B</span><?php echo $td=getRatio($data['bookings'],$data['redirect']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['bookings'],$prevdata['redirect']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B-Mob</span><?php echo $td=getRatio($data['bookingsmobile'],$data['redirectmobile']); ?>%</div>
                            <div class="col-lg-4 hide1"><?php echo $tp=getRatio($prevdata['bookingsmobile'],$prevdata['redirectmobile']); ?>%</div>
                            <div class="col-lg-4 <?php if($td>=$tp){ echo 'green';}else { echo 'red';} ?> hide1"><?php echo getPercentage($td,$tp); ?>% <i class="fa <?php if($td>=$tp){ echo 'fa-long-arrow-up size2';}else { echo 'fa-long-arrow-down size1'; } ?> "></i></div>
                                 </div>
                                <div class="col-lg-12 inner inner2">
                                <div class="col-lg-4 remove-data"><span class="rado-h">R/B-Web</span><?php echo $td=getRatio(($data['bookings']-$data['bookingsmobile']),($data['redirect']-$data['redirectmobile'])); ?>%</div>
