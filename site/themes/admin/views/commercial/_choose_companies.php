<div class="ibox-content">
    ...
    $data = \Yii::app()->db
            ->createCommand('SELECT ut.name, ut.id, COUNT(*) FROM user_info'
                    . ' JOIN user_type ut on ut.id = user_info.user_type_id'
                    . ' WHERE leading_char<>\'S\' AND commercial_plan_id IS NULL'
...
<script>
    function massAssign(userTypeId, select) {
        if (confirm('Are you sure for the mass assign?')) {
