...
<table id="Rule<?php echo $rule->id; ?>" class="table table-bordered table-condensed">
    ...
    ?>
    <tr>
        <td rowspan="8" style="vertical-align: top;" class="sinkavo">
            <?php
        ...
        <td rowspan="8" class="center sinkavo" style="vertical-align: top;">
            <?php
    ...
    <tr style="display: none;">
        <td colspan="7"><?php $this->renderPartial('/commercial/_filter_table', ['filter' => $filter]); ?></td>
    </tr>
</table>
