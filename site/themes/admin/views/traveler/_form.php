...
<fieldset>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php
            echo $form->dropDownList($model, 'traveler_title_id', CHtml::listData(TravelerTitle::model()->findAll(array('order' => 'id')), 'id', 'name'), array('style' => 'max-width: 70px;'));
