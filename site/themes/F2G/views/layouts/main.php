...
<html lang="en">
   ...
   <?php if(strstr(\Yii::app()->request->serverName, 'cheaptickets24') || Yii::app()->getBaseUrl(true)=='http://f2g.cheapticket'){?>
    <body id="app" class="Cheapticket">
<?php } else if(strstr(\Yii::app()->request->serverName, 'cheaptickets')){?>
    <body id="app">
