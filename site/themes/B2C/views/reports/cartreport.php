                                ...
                                <div class="ibox float-e-margins">
                                    <div class="ibox-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                            $col = 2;
                                            if ($csid != \ClientSource::SOURCE_SKYSCANNER) {
                                                $col = 4;
                                            }
                                            ?>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-12 box_co2 hadding2">
                                                    ...
                                                    <div class="col-lg-<?php echo $col;?>">
                                                        <div class="col-lg-6">PNR</div>
                                                        <div class="col-lg-6">Int/Dom</div>
                                                    </div>
                                                    <div class="col-lg-<?php echo $col;?>">
                                                        <div class="col-lg-6">Airline</div>
                                                        <div class="col-lg-6">Sector</div>
                                                    </div>
                                                    <?php if ($csid == \ClientSource::SOURCE_SKYSCANNER) { ?>
                                                        <div class="col-lg-2">
                                                            <div class="col-lg-6">Device</div>
                                                            <div class="col-lg-6">Order Value</div>
                                                        </div>    
                                                        <div class="col-lg-2">RedirectID</div>
                                                    <?php } ?>
                                                </div>
                                                <?php
                                                foreach ($data as $aircart) {
                                                    ...
                                                    <div class="col-lg-12 inner-2 strip2">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="col-lg-<?php echo $col;?>">
                                                                <div class="col-lg-6"><div class="col-lg-6 res">PNR</div><?php echo $aircart->airBookings[0]->airline_pnr; ?></div>
                                                                <div class="col-lg-6"><div class="col-lg-6 res"></div><?php
                                                            ...
                                                            ?>
                                                            <div class="col-lg-<?php echo $col;?>">
                                                                <div class="col-lg-6"><div class="col-lg-6 res">Airline</div><?php echo $str; ?></div>
                                                                <div class="col-lg-6"> <div class="col-lg-6 res"></div><?php echo $aircart->getSector(); ?></div>
                                                            </div>

                                                            <?php
                                                            if ($csid == \ClientSource::SOURCE_SKYSCANNER) {

                                                                $bookinglog = \BookingLog::model()->findByAttributes(['air_cart_id' => (int) $aircart->id]);
                                                                $device = '';
                                                                $redirect_id = '';
                                                                if (isset($bookinglog)) {
                                                                    ...
                                                                    $redirect_id = $bookinglog->ref_id;
                                                                }
                                                                $total_amount = $aircart->totalAmount() - $aircart->convenienceFee;
                                                                ?>
                                                                <div class="col-lg-2">
                                                                    <div class="col-lg-6"><div class="col-lg-6 res">Device</div><?php echo $device; ?></div>
                                                                    <div class="col-lg-6"> <div class="col-lg-6 res"></div><?php echo $total_amount; ?></div>
                                                                </div>
                                                                <div class="col-lg-2"><div class="col-lg-2 res">RedirectID</div>
                                                                <?php echo $redirect_id; ?>
                                                                </div>
                                                                <?php
                                                            }
                                                            ?>
