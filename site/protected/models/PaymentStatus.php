...
class PaymentStatus extends CActiveRecord {
    ...
    const STATUS_NOT_CHARGED = 1;
    const STATUS_BLOCKED = 2;
    const STATUS_CHARGED = 3;
    ...
    public function relations() {
        ...
        return array(
            'airCarts' => array(self::HAS_MANY, 'AirCart', 'payment_status_id'),
            'amendments' => array(self::HAS_MANY, 'Amendment', 'payment_status_id'),
        );
    }
