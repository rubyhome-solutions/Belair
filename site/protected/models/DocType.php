...
class DocType extends CActiveRecord {
    ...
    const LOGO_FILE_TYPE = 1;
    const OTHER_FILE_TYPE = 9;
    ...
    public function relations() {
        ...
        return array(
            'travelerFiles' => array(self::HAS_MANY, 'TravelerFile', 'doc_type_id'),
            'userFiles' => array(self::HAS_MANY, 'UserFile', 'doc_type_id'),
        );
    }
