...
?>
<p style="max-width: 850px;" class='well well-small alert-info'>&nbsp;&nbsp;<i class='fa fa-cog fa-2x fa-spin'></i><span style='vertical-align:super;'>&nbsp;&nbsp;&nbsp;Root Pass–through. This function change the active company to: <b><?php echo $model->userInfo->name;?></b></span></p>
<?php
