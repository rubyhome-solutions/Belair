...
<div class="form span9">
    <fieldset class="span3">
        ...
        <label><input type="radio" name="fop" value="0" onclick="$('#cc-details').hide()">&nbsp;Hold only</label>
        <label><input type="radio" name="fop" value="CA" checked="checked" onclick="$('#cc-details').hide()">&nbsp;Cash (CA)</label>
