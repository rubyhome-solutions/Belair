...
if ($isStaffLogged) {
    echo TbHtml::alert(TbHtml::ALERT_COLOR_INFO, 'The default payment gateway is choosen based on the client type.<br>Note that you still can <b>override</b> the default setting if needed!', ['style' => 'max-width:550px;']);
}
