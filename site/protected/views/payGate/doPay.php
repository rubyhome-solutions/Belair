...
// Atom case
if (in_array($model->pg_id, \PaymentGateway::$atomIdList)) {
    $this->renderPartial('_form_atom', ['model' => $model]);
}
...
// HDFC2
if (in_array($model->pg_id, \PaymentGateway::$hdfc2IdList)) {
    $this->renderPartial('_form_payU', [
        'model' => $model,
        'hide' => [
            'emi' => true,
