...
if (Authorization::getIsStaffLogged()) {
    ...
    <form id="yw0" class="search-form" action="/airCart/admin" method="get">
        ...
        <table class="table table-bordered table-condensed shadow" style="width: auto;">
            <tr class="center">
                <td colspan="6">
                    <a class="positive btn btn-info" style="padding-right: 0px !important;" href="/airCart/admin?AirCart[queue_type]=emailnotsent">Email Not Sent<span class="badge badge-warning badge-top" id="emailnotsent"></span></a>         
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=pending">Pending</a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=booked">Booked</a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=billed">Billed</a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=docsent">Doc Sent<span class="badge badge-warning badge-top" id="docsent"></span></a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=docrecvd">Doc Recvd<span class="badge badge-warning badge-top" id="docrecvd"></span></a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=farediffsent">Fare Diff Sent<span class="badge badge-warning badge-top" id="farediffsent"></span></a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=farediffrecvd">Fare Diff Recvd<span class="badge badge-warning badge-top" id="farediffrecvd"></span></a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=toamend">To Amend<span class="badge badge-warning badge-top" id="toamend"></span></a>
                    <a class="positive btn btn-info" href="/airCart/admin?AirCart[queue_type]=tocancel">To Cancel<span class="badge badge-warning badge-top" id="tocancel"></span></a>
                </td>
            </tr>
        </table>
    </form>
...
<div class="form shadow search-form" style="display:none">
    ...
    <table class="table table-bordered table-condensed">
        <tr class="center">
            <th class="heading">Cart ID</th>
            <td colspan="2"> <?php echo TbHtml::activeTextField($model, 'id'); ?></td>
            <td colspan="2"></td>
        </tr>
        <tr class="center">
            <th class="heading">Cart Filters</th>
        ...
        <tr class="center">
            <th class="heading">Traveler filter</th>
            <td colspan="2">
                <?php
            ...
            <th class="heading">User / Company filter</th>
            <td colspan="2">
                <?php
//                echo TbHtml::textField("user_filter", '', ['placeholder' => 'Anything about the user or the company', 'style' => 'max-width:260px;width:260px;']);
        ...
        <tr class="center">
            ...
            <th class="heading">Air PNR / CRS PNR / E-ticket</th>
            <td colspan="2">
                <?php
