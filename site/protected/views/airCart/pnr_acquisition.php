...
?>
<div class="form shadow span6" style="">
    <br>
    <?php
    ...
    echo TbHtml::error($model, 'airSourceId'); ?></td>
        ...
        <tr>
            <th class="heading">Choose the Website</th>
            <td style="text-align: center;"> 
            <?php echo TbHtml::activeDropDownList($model,'website_id' ,\Utils::getWebsiteNames()); ?>
            </td>
        </tr>
    </table>
    <?php
    echo TbHtml::submitButton('<i class="fa fa-search fa-lg"></i>&nbsp;&nbsp;PNR acquisition', array(
        ...
        'style' => 'margin-left:30%; margin-bottom:2%;',
    ));
    ?>
    <!--</div>-->
