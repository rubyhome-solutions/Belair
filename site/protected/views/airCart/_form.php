...
<div class="form">
    ...
    <?php echo $form->textFieldControlGroup($model, 'payment_id', array('span' => 5)); ?>

    <?php echo $form->textFieldControlGroup($model, 'booking_status_id', array('span' => 5)); ?>

    <?php echo $form->textFieldControlGroup($model, 'loged_user_id', array('span' => 5)); ?>

    <?php echo $form->textFieldControlGroup($model, 'payment_status_id', array('span' => 5)); ?>
