...
?>
<form class="form span6 noprint" method="POST" enctype="multipart/form-data" action="/ticketRulesSources/importRule"  id="fileForm">
    <fieldset>
        <legend>Import Sources Data</legend>
        <?php
