    ...
    <fieldset class="span3" style="margin-left: 1%">
        ...
        <?php if ($isStaffLogged) { ?>
            <div class="control-group">
                <label style="padding-top: 0;" class="control-label" for="UserInfo_rating">Company Rating</label>
...
<form class="form span4" style="margin-left: 0px;" method="POST" enctype="multipart/form-data">
    <fieldset>
        ...
        <label style="float: left; padding-top: 1%; margin-left: 5%;"><b>File Type&nbsp;&nbsp;</b></label>
        <?php
        ...
        ?>
        <label class="checkbox" style="float: left;margin-right: 10px;margin-left: 5%; display: <?php echo (Authorization::getIsStaffLogged()) ? 'block' : 'none'; ?>" >
