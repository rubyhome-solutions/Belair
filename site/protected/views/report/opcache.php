...
if (!extension_loaded('Zend OPcache') || opcache_get_configuration()['directives']['opcache.enable'] === false) {
...
class OpCacheDataModel {
    ...
    public function __construct() {
        if (function_exists('myOpcache_get_configuration')) {
            $this->_configuration = myOpcache_get_configuration();
            $this->_status = myOpcache_get_status();
        } else {
...
<html>
    <head>
        <style>
            ...
            .content-opcache table {
                width: 100%;
            }

            .content-opcache th, .tab:nth-child(3) td {
                text-align: left;
            }
            ...
            [type=radio]:checked ~ label ~ .content-opcache {
                z-index: 1;
            }
    ...
    <body>
        <div id="container-opcache">
            ...
            <div id="graph">
                <form>
                    <label class="radio inline"><input type="radio" name="dataset" value="memory" checked> Memory</label>
                    <label class="radio inline"><input type="radio" name="dataset" value="keys"> Keys</label>
                    <label class="radio inline"><input type="radio" name="dataset" value="hits"> Hits</label>
                    <label class="radio inline"><input type="radio" name="dataset" value="restarts"> Restarts</label>
                </form>
        ...
        <form action="/report/opcacheReset">
            <button type="submit" class="btn btn-primary" title="Never do this on production server!">Reset OpCode Cache</button>
        </form>

        <form action="/report/appCacheReset">
            <button type="submit" class="btn btn-primary" title="Never do this on production server!">Reset Application Cache</button>
        </form>

        <form action="/cluster/deactivateAllSlaves">
            <button type="submit" class="btn btn-primary" >Deactivate slaves</button>
        </form>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $(document).keyup(function (e) {
                    if (e.keyCode == 27)
                        handleVisualisationToggle(true);
