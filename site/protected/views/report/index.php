...
?>
<form name="report_criterion" method="post" action="/report/getScreenData" style="background-color: lightcyan; width: 70%" id="reportsForm">
    <div>
            ...
            <tbody><tr>
                    ...
                    <td>
                        <select id="reportType" name="reportType" onchange="reportChanged($(this).val())" style="width: 50%;">
                            ...
                            <option value="33">Cart ownership issues</option>
                                    ...
                                    'success' => "js: function(data){
                                            ...
                                            for (key in data) {
                                                if (data[key]['data'].length>1) {
                                                    chartsList.push({
                                                        id: data[key]['report'],
                                                        data: google.visualization.arrayToDataTable(data[key]['data']),
                                                        options: google.charts.Bar.convertOptions(data[key]['options'])
                                                    });
                                                    $('#' + data[key]['report']).html('');
                                                    document.getElementById(data[key]['report']).style.display = 'block';
                                                    //chart[key].draw(chartData[key], google.charts.Bar.convertOptions(data[key]['options']));
                                                } else {
                                                    document.getElementById(data[key]['report']).style.display = 'none';
                                                }
                                            }
                                            drawCharts(chartsList);
                                            $('#btnViewCharts').blur();
                                        }"
                                        ], [
                                    'class' => 'btn btn-info',
...
<script type="text/javascript">
    ...
    var PARAM_MAP = {
        ...
        '2_7': 't', '2_20': 't', '2_4': 't', '2_11': 't', '2_19': 't', '2_12': 't', '2_13': 't', '2_15': 't', '2_21': 't', '2_33': 'f', '2_40': 't',
