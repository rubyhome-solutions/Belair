...
$model->children = 0;
$model->infants = 0;
$model->depart = '2014-07-21';
//$model->return = '2014-07-30';
$model->return = null;
...
if (!empty($model->return)) {
    ...
    $f_mptbs->itinerary[1]->requestedSegmentRef->segRef = 1;
...
Utils::soapDebug($api);footer($start_timer); exit;
