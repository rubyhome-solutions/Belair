...
<div class="wra-content">
    <div class="box clearfix">
        <h2 class="heading">Domestic Flights</h2>
        ...
        <p class="save-up <?php echo ($model->way == BookingSearchForm::ROUND_TRIP) ? 'in' : '' ?>">save upto 1200</p>

    </div>
    <div class="row">
        <div class="span3" style="position: relative;">
            <label>From</label>
            <input type='text' class='typeahead' autocomplete="off" value='<?php echo (isset($cities[$model->source])) ? $cities[$model->source] : '' ?>' data-target='#BookingSearchForm_source'>
            <i class="fa fa-caret-down showtypeahead"></i>
            <?php echo CHtml::activeHiddenField($model, 'source'); ?>
            <?php echo $form->error($model, 'source', array('class' => 'alert alert-error')) ?>
        </div>
        <div class="span3" style="position: relative;">
            <label>To</label>
            <input type='text' class='typeahead' autocomplete="off" value='<?php echo (isset($cities[$model->destination])) ? $cities[$model->destination] : '' ?>' data-target='#BookingSearchForm_destination'>
            <i class="fa fa-caret-down showtypeahead"></i>
...
<fieldset class="span3 form" style="margin-top: 15px; 	border: 1px solid #DDD;
    ...
    <label><input type="radio" name="api" value="spicejetScrapper:34">&nbsp;Spicejet scrapper<br></label>
    <label><input type="radio" name="api" value="indigoScrapper:30">&nbsp;Indigo scrapper<br></label>
    ...
    <label><input type="radio" name="api" value="AmadeusV2:test" checked="checked">&nbsp;Amadeus test V2<br></label>
    ...
    <!--<label><input type="radio" name="api" value="SpiceJet_v2">&nbsp;SpiceJet production v.2<br></label>-->
    ...
    <label><input type="radio" name="api" value="GoAir">&nbsp;GoAir test<br></label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.showtypeahead').click(function () {

            var el = $(this).parent().find('.typeahead');

            $(el).autocomplete('enable');
            $(el).trigger('focus').autocomplete('search', '');
