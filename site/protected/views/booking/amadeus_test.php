...
//}
    ...
    if ($model->adults > 0) {
        ...
        $pr->ptc = 'ADT';
        for ($i = 0; $i < $model->adults; $i++) {
            $traveller = new application\components\Amadeus\test\traveller;
            $traveller->ref = $ref;
            $ref++;
...
//exit;
    ?>
    <p class="well well-small alert-info">&nbsp;<i class="fa fa-search fa-lg"></i>&nbsp;&nbsp;Amadeus test search results</p>
