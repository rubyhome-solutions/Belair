<h3>Indigo production results v2</h3>
<?php
        ...
        <tr>
            ...
            foreach ($legs as $leg) {
                ...
                foreach ($passengers as $passenger) {
                    ...
                    <td><?php  if(isset($secondSegment) && isset($fares[$fsk2])){
                          echo ($fares[$fsk]['baseAmount'] + $fares[$fsk]['amount']+$fares[$fsk2]['baseAmount']+$fares[$fsk2]['amount']);
                        }else{
                        echo ($fares[$fsk]['baseAmount'] + $fares[$fsk]['amount']);
                        } ?></td>
                        <td><?php if(isset($secondSegment) && isset($fares[$fsk2])){
                            echo ($fares[$fsk]['baseAmount'] + $fares[$fsk2]['baseAmount']); 
                         }else{
                            echo ($fares[$fsk]['baseAmount']);
                            } ?></td>
                        <td><?php
