...
?>
<form class="form span6 noprint" method="POST" enctype="multipart/form-data" action="/ticketRulesAirline/importRule"  id="fileForm">
    <fieldset>
        <legend>Import Airline Data</legend>
        <?php
