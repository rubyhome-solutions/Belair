...
namespace application\components\Goair\test;
...
class GoAir {
    ...
    public function getToken() {
        ...
        $res = \Utils::curl('http://g8.tpapi.uat.radixx.com/RadixxSecurity.asmx/GetSecurityGUID', http_build_query([
        ...
        if ($res['result'] === false) {
            ...
            $this->_token = (string) simplexml_load_string($res['result']);
    ...
    public function getOriginAirports() {
        $this->getToken();
        $res = \Utils::curl('http://g8.tpapi.uat.radixx.com/RadixxAirports.asmx/GetOriginAirportsXML', http_build_query([
...
//            file_put_contents('g8_origin_airports.xml', html_entity_decode($res['result']));
    ...
    public function getDestinationAirports($srcAirportCode) {
        $this->getToken();
        $res = \Utils::curl('http://g8.tpapi.uat.radixx.com/RadixxAirports.asmx/GetDestinationAirportsXML', http_build_query([
                    'SecurityGUID' => $this->_token,
    ...
    public function loginTravelAgencyUser() {
        ...
        $res = \Utils::curl('http://g8.tpapi.uat.radixx.com/RadixxTravelAgents.asmx/LoginTravelAgencyUser', http_build_query([
                    'SecurityGUID' => $this->_token,
...
//        file_put_contents('G8_request.xml', $strXml);
        $res = \Utils::curl('http://g8.tpapi.uat.radixx.com/RadixxFlights.asmx/GetFareQuote', http_build_query([
                    'SecurityGUID' => $this->_token,
