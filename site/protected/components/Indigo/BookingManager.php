...
class BookingManager extends \SoapClient {
    ...
    private static $classmap = array(
        'FlightDesignator' => 'application\components\Indigo\FlightDesignator',
        'StateMessage' => 'application\components\Indigo\StateMessage',
        'OtherServiceInformation' => 'application\components\Indigo\OtherServiceInformation',
        'PointOfSale' => 'application\components\Indigo\PointOfSale',
        'RecordLocator' => 'application\components\Indigo\RecordLocator',
        'TCOrderItem' => 'application\components\Indigo\TCOrderItem',
        'TCResponse' => 'application\components\Indigo\TCResponse',
        'OrderPayment' => 'application\components\Indigo\OrderPayment',
        'TCWarning' => 'application\components\Indigo\TCWarning',
        'TermsConditions' => 'application\components\Indigo\TermsConditions',
        'Participant' => 'application\components\Indigo\Participant',
        'RequestedFieldOfstring' => 'application\components\Indigo\RequestedFieldOfstring',
        'RequestedFieldOfdateTime' => 'application\components\Indigo\RequestedFieldOfdateTime',
        'OrderCustomer' => 'application\components\Indigo\OrderCustomer',
        'OrderHandling' => 'application\components\Indigo\OrderHandling',
        'ChargeableItem' => 'application\components\Indigo\ChargeableItem',
        'OrderDiscount' => 'application\components\Indigo\OrderDiscount',
        'DiscountTarget' => 'application\components\Indigo\DiscountTarget',
        'OrderItemAddress' => 'application\components\Indigo\OrderItemAddress',
        'OrderItemPersonalization' => 'application\components\Indigo\OrderItemPersonalization',
        'OrderItemSkuDetail' => 'application\components\Indigo\OrderItemSkuDetail',
        'OrderItemNote' => 'application\components\Indigo\OrderItemNote',
        'OrderItemLocator' => 'application\components\Indigo\OrderItemLocator',
        'Fee' => 'application\components\Indigo\Fee',
        'OrderItemLocation' => 'application\components\Indigo\OrderItemLocation',
        'OrderItemParameter' => 'application\components\Indigo\OrderItemParameter',
        'OrderItemStatusHistory' => 'application\components\Indigo\OrderItemStatusHistory',
        'OrderItemElement' => 'application\components\Indigo\OrderItemElement',
        'KeyValuePairOfstringstring' => 'application\components\Indigo\KeyValuePairOfstringstring',
        'TicketRequest' => 'application\components\Indigo\TicketRequest',
        'SegmentTicketRequest' => 'application\components\Indigo\SegmentTicketRequest',
        'PaxTicketUpdate' => 'application\components\Indigo\PaxTicketUpdate',
        'BookingUpdateResponseData' => 'application\components\Indigo\BookingUpdateResponseData',
        'Success' => 'application\components\Indigo\Success',
        'BookingSum' => 'application\components\Indigo\BookingSum',
        'Warning' => 'application\components\Indigo\Warning',
        'Error' => 'application\components\Indigo\Error',
        'UpgradeRequestData' => 'application\components\Indigo\UpgradeRequestData',
        'UpgradeSegmentRequest' => 'application\components\Indigo\UpgradeSegmentRequest',
        'DowngradeRequestData' => 'application\components\Indigo\DowngradeRequestData',
        'DowngradeSegmentRequest' => 'application\components\Indigo\DowngradeSegmentRequest',
        'UpgradeAvailabilityRequest' => 'application\components\Indigo\UpgradeAvailabilityRequest',
        'UpgradeAvailabilityResponse' => 'application\components\Indigo\UpgradeAvailabilityResponse',
        'ServiceMessage' => 'application\components\Indigo\ServiceMessage',
        'UpgradeSegment' => 'application\components\Indigo\UpgradeSegment',
        'Upgrade' => 'application\components\Indigo\Upgrade',
        'PassengerFee' => 'application\components\Indigo\PassengerFee',
        'BookingServiceCharge' => 'application\components\Indigo\BookingServiceCharge',
        'UpdateSourcePointOfSaleRequest' => 'application\components\Indigo\UpdateSourcePointOfSaleRequest',
        'MoveJourneyBookingsRequestData' => 'application\components\Indigo\MoveJourneyBookingsRequestData',
        'Journey' => 'application\components\Indigo\Journey',
        'Segment' => 'application\components\Indigo\Segment',
        'Fare' => 'application\components\Indigo\Fare',
        'PaxFare' => 'application\components\Indigo\PaxFare',
        'AvailableFare' => 'application\components\Indigo\AvailableFare',
        'Leg' => 'application\components\Indigo\Leg',
        'LegInfo' => 'application\components\Indigo\LegInfo',
        'LegNest' => 'application\components\Indigo\LegNest',
        'LegClass' => 'application\components\Indigo\LegClass',
        'LegSSR' => 'application\components\Indigo\LegSSR',
        'OperationsInfo' => 'application\components\Indigo\OperationsInfo',
        'PaxBag' => 'application\components\Indigo\PaxBag',
        'PaxSeat' => 'application\components\Indigo\PaxSeat',
        'PaxSeatInfo' => 'application\components\Indigo\PaxSeatInfo',
        'PaxSSR' => 'application\components\Indigo\PaxSSR',
        'PaxSegment' => 'application\components\Indigo\PaxSegment',
        'PaxTicket' => 'application\components\Indigo\PaxTicket',
        'PaxSeatPreference' => 'application\components\Indigo\PaxSeatPreference',
        'PaxScore' => 'application\components\Indigo\PaxScore',
        'MoveJourneyBookingsResponseData' => 'application\components\Indigo\MoveJourneyBookingsResponseData',
        'MoveBookingResult' => 'application\components\Indigo\MoveBookingResult',
        'MoveJourneyByKeyRequestData' => 'application\components\Indigo\MoveJourneyByKeyRequestData',
        'SellKeyList' => 'application\components\Indigo\SellKeyList',
        'EquipmentListRequest' => 'application\components\Indigo\EquipmentListRequest',
        'EquipmentRequest' => 'application\components\Indigo\EquipmentRequest',
        'EquipmentListResponse' => 'application\components\Indigo\EquipmentListResponse',
        'EquipmentResponse' => 'application\components\Indigo\EquipmentResponse',
        'EquipmentInfo' => 'application\components\Indigo\EquipmentInfo',
        'CompartmentInfo' => 'application\components\Indigo\CompartmentInfo',
        'SeatInfo' => 'application\components\Indigo\SeatInfo',
        'EquipmentProperty' => 'application\components\Indigo\EquipmentProperty',
        'LegKey' => 'application\components\Indigo\LegKey',
        'EquipmentPropertyTypeCodesLookup' => 'application\components\Indigo\EquipmentPropertyTypeCodesLookup',
        'FeeRequest' => 'application\components\Indigo\FeeRequest',
        'Booking' => 'application\components\Indigo\Booking',
        'BookingInfo' => 'application\components\Indigo\BookingInfo',
        'TypeOfSale' => 'application\components\Indigo\TypeOfSale',
        'BookingHold' => 'application\components\Indigo\BookingHold',
        'ReceivedByInfo' => 'application\components\Indigo\ReceivedByInfo',
        'Passenger' => 'application\components\Indigo\Passenger',
        'PassengerProgram' => 'application\components\Indigo\PassengerProgram',
        'BookingName' => 'application\components\Indigo\BookingName',
        'PassengerInfant' => 'application\components\Indigo\PassengerInfant',
        'PassengerInfo' => 'application\components\Indigo\PassengerInfo',
        'PassengerAddress' => 'application\components\Indigo\PassengerAddress',
        'PassengerTravelDocument' => 'application\components\Indigo\PassengerTravelDocument',
        'PassengerBag' => 'application\components\Indigo\PassengerBag',
        'PassengerTypeInfo' => 'application\components\Indigo\PassengerTypeInfo',
        'BookingComment' => 'application\components\Indigo\BookingComment',
        'BookingQueueInfo' => 'application\components\Indigo\BookingQueueInfo',
        'BookingContact' => 'application\components\Indigo\BookingContact',
        'Payment' => 'application\components\Indigo\Payment',
        'DCC' => 'application\components\Indigo\DCC',
        'ThreeDSecure' => 'application\components\Indigo\ThreeDSecure',
        'PaymentField' => 'application\components\Indigo\PaymentField',
        'PaymentAddress' => 'application\components\Indigo\PaymentAddress',
        'BookingComponent' => 'application\components\Indigo\BookingComponent',
        'BookingComponentCharge' => 'application\components\Indigo\BookingComponentCharge',
        'OrderItem' => 'application\components\Indigo\OrderItem',
        'UpdatePassengersRequestData' => 'application\components\Indigo\UpdatePassengersRequestData',
        'SSRRequest' => 'application\components\Indigo\SSRRequest',
        'SegmentSSRRequest' => 'application\components\Indigo\SegmentSSRRequest',
        'PriceRequestData' => 'application\components\Indigo\PriceRequestData',
        'CaptureBaggageEventRequestData' => 'application\components\Indigo\CaptureBaggageEventRequestData',
        'CaptureBaggageEventResponseData' => 'application\components\Indigo\CaptureBaggageEventResponseData',
        'FindBaggageEventRequestData' => 'application\components\Indigo\FindBaggageEventRequestData',
        'FindBaggageEventResponseData' => 'application\components\Indigo\FindBaggageEventResponseData',
        'BaggageEvent' => 'application\components\Indigo\BaggageEvent',
        'GuestValuesRequest' => 'application\components\Indigo\GuestValuesRequest',
        'BookingByRecordLocator' => 'application\components\Indigo\BookingByRecordLocator',
        'BookingByBookingID' => 'application\components\Indigo\BookingByBookingID',
        'PassengerScoresRequest' => 'application\components\Indigo\PassengerScoresRequest',
        'PassengerScoresResponse' => 'application\components\Indigo\PassengerScoresResponse',
        'PassengerScore' => 'application\components\Indigo\PassengerScore',
        'BookingCommitRequestData' => 'application\components\Indigo\BookingCommitRequestData',
        'ResellSSR' => 'application\components\Indigo\ResellSSR',
        'UpdateContactsRequestData' => 'application\components\Indigo\UpdateContactsRequestData',
        'UpdateBookingComponentDataRequestData' => 'application\components\Indigo\UpdateBookingComponentDataRequestData',
        'UpdateType' => 'application\components\Indigo\UpdateType',
        'TravelCommerceSellRequestData' => 'application\components\Indigo\TravelCommerceSellRequestData',
        'TripAvailabilityRequest' => 'application\components\Indigo\TripAvailabilityRequest',
        'AvailabilityRequest' => 'application\components\Indigo\AvailabilityRequest',
        'Time' => 'application\components\Indigo\Time',
        'PaxPriceType' => 'application\components\Indigo\PaxPriceType',
        'TripAvailabilityResponse' => 'application\components\Indigo\TripAvailabilityResponse',
        'JourneyDateMarket' => 'application\components\Indigo\JourneyDateMarket',
        'AvailabilityResponse' => 'application\components\Indigo\AvailabilityResponse',
        'LowFareTripAvailabilityRequest' => 'application\components\Indigo\LowFareTripAvailabilityRequest',
        'LowFareAvailabilityRequest' => 'application\components\Indigo\LowFareAvailabilityRequest',
        'LowFareTripAvailabilityResponse' => 'application\components\Indigo\LowFareTripAvailabilityResponse',
        'LowFareAvailabilityResponse' => 'application\components\Indigo\LowFareAvailabilityResponse',
        'DateMarketLowFare' => 'application\components\Indigo\DateMarketLowFare',
        'MoveAvailabilityRequest' => 'application\components\Indigo\MoveAvailabilityRequest',
        'MoveAvailabilityResponse' => 'application\components\Indigo\MoveAvailabilityResponse',
        'MoveFeePriceRequest' => 'application\components\Indigo\MoveFeePriceRequest',
        'MoveFeePriceResponse' => 'application\components\Indigo\MoveFeePriceResponse',
        'MoveFeePriceItem' => 'application\components\Indigo\MoveFeePriceItem',
        'SeparateSegmentByEquipmentResponseData' => 'application\components\Indigo\SeparateSegmentByEquipmentResponseData',
        'SSRAvailabilityRequest' => 'application\components\Indigo\SSRAvailabilityRequest',
        'SSRAvailabilityResponse' => 'application\components\Indigo\SSRAvailabilityResponse',
        'InventorySegmentSSRNest' => 'application\components\Indigo\InventorySegmentSSRNest',
        'SSRAvailabilityForBookingRequest' => 'application\components\Indigo\SSRAvailabilityForBookingRequest',
        'SSRAvailabilityForBookingResponse' => 'application\components\Indigo\SSRAvailabilityForBookingResponse',
        'SSRSegment' => 'application\components\Indigo\SSRSegment',
        'AvailablePaxSSR' => 'application\components\Indigo\AvailablePaxSSR',
        'PaxSSRPrice' => 'application\components\Indigo\PaxSSRPrice',
        'SSRLeg' => 'application\components\Indigo\SSRLeg',
        'FindBookingRequestData' => 'application\components\Indigo\FindBookingRequestData',
        'FindByContact' => 'application\components\Indigo\FindByContact',
        'FindByRecordLocator' => 'application\components\Indigo\FindByRecordLocator',
        'FindByThirdPartyRecordLocator' => 'application\components\Indigo\FindByThirdPartyRecordLocator',
        'FindByName' => 'application\components\Indigo\FindByName',
        'Filter' => 'application\components\Indigo\Filter',
        'FindByAgentID' => 'application\components\Indigo\FindByAgentID',
        'FindByAgentName' => 'application\components\Indigo\FindByAgentName',
        'FindByAgencyNumber' => 'application\components\Indigo\FindByAgencyNumber',
        'FindByEmailAddress' => 'application\components\Indigo\FindByEmailAddress',
        'FindByPhoneNumber' => 'application\components\Indigo\FindByPhoneNumber',
        'FindByCreditCardNumber' => 'application\components\Indigo\FindByCreditCardNumber',
        'FindByCustomerNumber' => 'application\components\Indigo\FindByCustomerNumber',
        'FindByContactCustomerNumber' => 'application\components\Indigo\FindByContactCustomerNumber',
        'FindByCustomer' => 'application\components\Indigo\FindByCustomer',
        'FindByBagTag' => 'application\components\Indigo\FindByBagTag',
        'FindByTravelDocument' => 'application\components\Indigo\FindByTravelDocument',
        'FindByBookingDate' => 'application\components\Indigo\FindByBookingDate',
        'FindBookingResponseData' => 'application\components\Indigo\FindBookingResponseData',
        'FindBookingData' => 'application\components\Indigo\FindBookingData',
        'GetBookingRequestData' => 'application\components\Indigo\GetBookingRequestData',
        'GetByRecordLocator' => 'application\components\Indigo\GetByRecordLocator',
        'GetByThirdPartyRecordLocator' => 'application\components\Indigo\GetByThirdPartyRecordLocator',
        'GetByID' => 'application\components\Indigo\GetByID',
        'GetBookingHistoryRequestData' => 'application\components\Indigo\GetBookingHistoryRequestData',
        'GetBookingHistoryResponseData' => 'application\components\Indigo\GetBookingHistoryResponseData',
        'BookingHistory' => 'application\components\Indigo\BookingHistory',
        'GetBookingBaggageRequestData' => 'application\components\Indigo\GetBookingBaggageRequestData',
        'AcceptScheduleChangesRequestData' => 'application\components\Indigo\AcceptScheduleChangesRequestData',
        'AddBookingCommentsRequestData' => 'application\components\Indigo\AddBookingCommentsRequestData',
        'RecordLocatorListRequest' => 'application\components\Indigo\RecordLocatorListRequest',
        'CancelRequestData' => 'application\components\Indigo\CancelRequestData',
        'CancelJourney' => 'application\components\Indigo\CancelJourney',
        'CancelJourneyRequest' => 'application\components\Indigo\CancelJourneyRequest',
        'CancelFee' => 'application\components\Indigo\CancelFee',
        'CancelSSR' => 'application\components\Indigo\CancelSSR',
        'DivideRequestData' => 'application\components\Indigo\DivideRequestData',
        'BookingPaymentTransfer' => 'application\components\Indigo\BookingPaymentTransfer',
        'FareOverrideRequestData' => 'application\components\Indigo\FareOverrideRequestData',
        'GetBookingPaymentsRequestData' => 'application\components\Indigo\GetBookingPaymentsRequestData',
        'GetBookingPaymentResponseData' => 'application\components\Indigo\GetBookingPaymentResponseData',
        'AddPaymentToBookingRequestData' => 'application\components\Indigo\AddPaymentToBookingRequestData',
        'AgencyAccount' => 'application\components\Indigo\AgencyAccount',
        'CreditShell' => 'application\components\Indigo\CreditShell',
        'CreditFile' => 'application\components\Indigo\CreditFile',
        'PaymentVoucher' => 'application\components\Indigo\PaymentVoucher',
        'ThreeDSecureRequest' => 'application\components\Indigo\ThreeDSecureRequest',
        'MCCRequest' => 'application\components\Indigo\MCCRequest',
        'AddPaymentToBookingResponseData' => 'application\components\Indigo\AddPaymentToBookingResponseData',
        'ValidationPayment' => 'application\components\Indigo\ValidationPayment',
        'PaymentValidationError' => 'application\components\Indigo\PaymentValidationError',
        'ApplyPromotionRequestData' => 'application\components\Indigo\ApplyPromotionRequestData',
        'DCCQueryRequestData' => 'application\components\Indigo\DCCQueryRequestData',
        'PaymentFeePriceRequest' => 'application\components\Indigo\PaymentFeePriceRequest',
        'PaymentFeePriceResponse' => 'application\components\Indigo\PaymentFeePriceResponse',
        'SeatAvailabilityRequest' => 'application\components\Indigo\SeatAvailabilityRequest',
        'EquipmentDeviation' => 'application\components\Indigo\EquipmentDeviation',
        'SeatAvailabilityResponse' => 'application\components\Indigo\SeatAvailabilityResponse',
        'SeatGroupPassengerFee' => 'application\components\Indigo\SeatGroupPassengerFee',
        'SeatAvailabilityLeg' => 'application\components\Indigo\SeatAvailabilityLeg',
        'SeatSellRequest' => 'application\components\Indigo\SeatSellRequest',
        'SegmentSeatRequest' => 'application\components\Indigo\SegmentSeatRequest',
        'CommitRequestData' => 'application\components\Indigo\CommitRequestData',
        'ItineraryPriceRequest' => 'application\components\Indigo\ItineraryPriceRequest',
        'SellJourneyByKeyRequestData' => 'application\components\Indigo\SellJourneyByKeyRequestData',
        'PriceJourneyRequestData' => 'application\components\Indigo\PriceJourneyRequestData',
        'PriceJourney' => 'application\components\Indigo\PriceJourney',
        'PriceSegment' => 'application\components\Indigo\PriceSegment',
        'SellFare' => 'application\components\Indigo\SellFare',
        'PriceLeg' => 'application\components\Indigo\PriceLeg',
        'SellRequestData' => 'application\components\Indigo\SellRequestData',
        'SellJourneyByKeyRequest' => 'application\components\Indigo\SellJourneyByKeyRequest',
        'SellJourneyRequest' => 'application\components\Indigo\SellJourneyRequest',
        'SellJourneyRequestData' => 'application\components\Indigo\SellJourneyRequestData',
        'SellJourney' => 'application\components\Indigo\SellJourney',
        'SellSegment' => 'application\components\Indigo\SellSegment',
        'SellSSR' => 'application\components\Indigo\SellSSR',
        'SellFee' => 'application\components\Indigo\SellFee',
        'SellFeeRequestData' => 'application\components\Indigo\SellFeeRequestData',
        'UpdateFeeStatusRequestData' => 'application\components\Indigo\UpdateFeeStatusRequestData',
        'FeeStatusRequest' => 'application\components\Indigo\FeeStatusRequest',
        'ServiceCancelRequest' => 'application\components\Indigo\ServiceCancelRequest',
        'UpdateTicketsRequest' => 'application\components\Indigo\UpdateTicketsRequest',
        'UpdateTicketsResponse' => 'application\components\Indigo\UpdateTicketsResponse',
        'UpgradeRequest' => 'application\components\Indigo\UpgradeRequest',
        'UpgradeResponse' => 'application\components\Indigo\UpgradeResponse',
        'DowngradeRequest' => 'application\components\Indigo\DowngradeRequest',
        'DowngradeResponse' => 'application\components\Indigo\DowngradeResponse',
        'GetUpgradeAvailabilityRequest' => 'application\components\Indigo\GetUpgradeAvailabilityRequest',
        'GetUpgradeAvailabilityResponse' => 'application\components\Indigo\GetUpgradeAvailabilityResponse',
        'ChangeSourcePointOfSaleRequest' => 'application\components\Indigo\ChangeSourcePointOfSaleRequest',
        'ChangeSourcePointOfSaleResponse' => 'application\components\Indigo\ChangeSourcePointOfSaleResponse',
        'GetEquipmentPropertiesRequest' => 'application\components\Indigo\GetEquipmentPropertiesRequest',
        'GetEquipmentPropertiesResponse' => 'application\components\Indigo\GetEquipmentPropertiesResponse',
        'OverrideFeeRequest' => 'application\components\Indigo\OverrideFeeRequest',
        'OverrideFeeResponse' => 'application\components\Indigo\OverrideFeeResponse',
        'UpdatePassengersRequest' => 'application\components\Indigo\UpdatePassengersRequest',
        'UpdatePassengerResponse' => 'application\components\Indigo\UpdatePassengerResponse',
        'UpdateSSRRequest' => 'application\components\Indigo\UpdateSSRRequest',
        'UpdateSSRResponse' => 'application\components\Indigo\UpdateSSRResponse',
        'UpdatePriceRequest' => 'application\components\Indigo\UpdatePriceRequest',
        'UpdatePriceResponse' => 'application\components\Indigo\UpdatePriceResponse',
        'CaptureBaggageEventRequest' => 'application\components\Indigo\CaptureBaggageEventRequest',
        'CaptureBaggageEventResponse' => 'application\components\Indigo\CaptureBaggageEventResponse',
        'CalculateGuestValuesRequest' => 'application\components\Indigo\CalculateGuestValuesRequest',
        'CalculateGuestValuesResponse' => 'application\components\Indigo\CalculateGuestValuesResponse',
        'ScorePassengersRequest' => 'application\components\Indigo\ScorePassengersRequest',
        'ScorePassengersResponse' => 'application\components\Indigo\ScorePassengersResponse',
        'BookingCommitRequest' => 'application\components\Indigo\BookingCommitRequest',
        'BookingCommitResponse' => 'application\components\Indigo\BookingCommitResponse',
        'ResellSSRRequest' => 'application\components\Indigo\ResellSSRRequest',
        'ResellSSRResponse' => 'application\components\Indigo\ResellSSRResponse',
        'UpdateContactsRequest' => 'application\components\Indigo\UpdateContactsRequest',
        'UpdateContactsResponse' => 'application\components\Indigo\UpdateContactsResponse',
        'UpdateBookingComponentDataRequest' => 'application\components\Indigo\UpdateBookingComponentDataRequest',
        'UpdateBookingComponentDataResponse' => 'application\components\Indigo\UpdateBookingComponentDataResponse',
        'TravelCommerceSellRequest' => 'application\components\Indigo\TravelCommerceSellRequest',
        'TravelCommerceSellResponse' => 'application\components\Indigo\TravelCommerceSellResponse',
        'TravelCommerceCancelServiceRequest' => 'application\components\Indigo\TravelCommerceCancelServiceRequest',
        'TravelCommerceCancelServiceResponse' => 'application\components\Indigo\TravelCommerceCancelServiceResponse',
        'GetAvailabilityRequest' => 'application\components\Indigo\GetAvailabilityRequest',
        'GetAvailabilityByTripResponse' => 'application\components\Indigo\GetAvailabilityByTripResponse',
        'GetLowFareAvailabilityRequest' => 'application\components\Indigo\GetLowFareAvailabilityRequest',
        'GetLowFareAvailabilityResponse' => 'application\components\Indigo\GetLowFareAvailabilityResponse',
        'GetLowFareTripAvailabilityRequest' => 'application\components\Indigo\GetLowFareTripAvailabilityRequest',
        'GetLowFareTripAvailabilityResponse' => 'application\components\Indigo\GetLowFareTripAvailabilityResponse',
        'GetMoveAvailabilityRequest' => 'application\components\Indigo\GetMoveAvailabilityRequest',
        'GetMoveAvailabilityResponse' => 'application\components\Indigo\GetMoveAvailabilityResponse',
        'GetMoveFeePriceRequest' => 'application\components\Indigo\GetMoveFeePriceRequest',
        'GetMoveFeePriceResponse' => 'application\components\Indigo\GetMoveFeePriceResponse',
        'GetSSRAvailabilityRequest' => 'application\components\Indigo\GetSSRAvailabilityRequest',
        'GetSSRAvailabilityResponse' => 'application\components\Indigo\GetSSRAvailabilityResponse',
        'GetSSRAvailabilityForBookingRequest' => 'application\components\Indigo\GetSSRAvailabilityForBookingRequest',
        'GetSSRAvailabilityForBookingResponse' => 'application\components\Indigo\GetSSRAvailabilityForBookingResponse',
        'GetBookingRequest' => 'application\components\Indigo\GetBookingRequest',
        'GetBookingResponse' => 'application\components\Indigo\GetBookingResponse',
        'GetBookingFromStateResponse' => 'application\components\Indigo\GetBookingFromStateResponse',
        'GetBookingHistoryRequest' => 'application\components\Indigo\GetBookingHistoryRequest',
        'GetBookingHistoryResponse' => 'application\components\Indigo\GetBookingHistoryResponse',
        'GetBookingBaggageRequest' => 'application\components\Indigo\GetBookingBaggageRequest',
        'GetBookingBaggageResponse' => 'application\components\Indigo\GetBookingBaggageResponse',
        'AcceptScheduleChangesRequest' => 'application\components\Indigo\AcceptScheduleChangesRequest',
        'AddBookingCommentsRequest' => 'application\components\Indigo\AddBookingCommentsRequest',
        'AddBookingCommentsResponse' => 'application\components\Indigo\AddBookingCommentsResponse',
        'GetRecordLocatorListRequest' => 'application\components\Indigo\GetRecordLocatorListRequest',
        'GetRecordLocatorListResponse' => 'application\components\Indigo\GetRecordLocatorListResponse',
        'CancelRequest' => 'application\components\Indigo\CancelRequest',
        'CancelResponse' => 'application\components\Indigo\CancelResponse',
        'DivideRequest' => 'application\components\Indigo\DivideRequest',
        'DivideResponse' => 'application\components\Indigo\DivideResponse',
        'FareOverrideRequest' => 'application\components\Indigo\FareOverrideRequest',
        'FareOverrideResponse' => 'application\components\Indigo\FareOverrideResponse',
        'GetBookingPaymentsRequest' => 'application\components\Indigo\GetBookingPaymentsRequest',
        'GetBookingPaymentsResponse' => 'application\components\Indigo\GetBookingPaymentsResponse',
        'AddPaymentToBookingRequest' => 'application\components\Indigo\AddPaymentToBookingRequest',
        'AddPaymentToBookingResponse' => 'application\components\Indigo\AddPaymentToBookingResponse',
        'AddInProcessPaymentToBookingRequest' => 'application\components\Indigo\AddInProcessPaymentToBookingRequest',
        'AddInProcessPaymentToBookingResponse' => 'application\components\Indigo\AddInProcessPaymentToBookingResponse',
        'ApplyPromotionRequest' => 'application\components\Indigo\ApplyPromotionRequest',
        'ApplyPromotionResponse' => 'application\components\Indigo\ApplyPromotionResponse',
        'DCCQueryRequest' => 'application\components\Indigo\DCCQueryRequest',
        'DCCQueryResponse' => 'application\components\Indigo\DCCQueryResponse',
        'DCCPaymentResponse' => 'application\components\Indigo\DCCPaymentResponse',
        'GetPaymentFeePriceRequest' => 'application\components\Indigo\GetPaymentFeePriceRequest',
        'GetPaymentFeePriceResponse' => 'application\components\Indigo\GetPaymentFeePriceResponse',
        'GetSeatAvailabilityRequest' => 'application\components\Indigo\GetSeatAvailabilityRequest',
        'GetSeatAvailabilityResponse' => 'application\components\Indigo\GetSeatAvailabilityResponse',
        'AssignSeatsRequest' => 'application\components\Indigo\AssignSeatsRequest',
        'AssignSeatsResponse' => 'application\components\Indigo\AssignSeatsResponse',
        'UnassignSeatsRequest' => 'application\components\Indigo\UnassignSeatsRequest',
        'UnassignSeatsResponse' => 'application\components\Indigo\UnassignSeatsResponse',
        'CommitRequest' => 'application\components\Indigo\CommitRequest',
        'CommitResponse' => 'application\components\Indigo\CommitResponse',
        'PriceItineraryRequest' => 'application\components\Indigo\PriceItineraryRequest',
        'PriceItineraryResponse' => 'application\components\Indigo\PriceItineraryResponse',
        'SellRequest' => 'application\components\Indigo\SellRequest',
        'SellResponse' => 'application\components\Indigo\SellResponse',
        'UpdateFeeStatusRequest' => 'application\components\Indigo\UpdateFeeStatusRequest',
        'GetBookingFromStateRequest' => 'application\components\Indigo\GetBookingFromStateRequest');
    ...
    public function __construct($signature, array $options = [], $wsdl = 'production') {
        set_time_limit(90);     // More time is needed
...
//            \Yii::log('We are using proxy for Indigo!');
        }
...
//        \Utils::dbgYiiLog('Indigo request prepared to be sent: ' . gmdate(DATE_RFC850));
        try {
...
//        \Utils::dbgYiiLog('Indigo GetItineraryPrice request prepared to be sent at: ' . gmdate(DATE_RFC2822));
       try {
