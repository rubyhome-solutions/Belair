...
class SessionManager extends \SoapClient {
    ...
    private static $classmap = array(
        'LogonRequestData' => 'application\components\Indigo\LogonRequestData',
        'TokenRequest' => 'application\components\Indigo\TokenRequest',
        'TransferSessionResponseData' => 'application\components\Indigo\TransferSessionResponseData',
        'ChangePasswordRequest' => 'application\components\Indigo\ChangePasswordRequest',
        'LogonRequest' => 'application\components\Indigo\LogonRequest',
        'LogoutRequest' => 'application\components\Indigo\LogoutRequest',
        'TransferSessionRequest' => 'application\components\Indigo\TransferSessionRequest',
        'TransferSessionResponse' => 'application\components\Indigo\TransferSessionResponse',
        'LogonResponse' => 'application\components\Indigo\LogonResponse');
    ...
    public function __construct(array $options = [], $wsdl = 'production') {
        ...
        // Local options - valid for Indigo SOAP
...
//            \Yii::log('We are using proxy for Indigo!');
    ...
    /**
     *
     * @param int $id Indigo test is 28
     * @access public
     * @return LogonResponse
     */
    public function Logon($id = 28) {
//        \Utils::dbgYiiLog('Indigo LOGON request prepared to be sent: ' . gmdate(DATE_RSS));
...
class LogonRequestData {
     ...
     * @access public
     */
    public function __construct($id = 28) {
