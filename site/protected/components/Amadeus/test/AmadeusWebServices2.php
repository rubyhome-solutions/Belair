...
class AmadeusWebServices2 extends \SoapClient {
     ...
     * @access public
     */
    public function __construct(array $options = array(), $wsdl = '1ASIWBELBEL_PDT_20140114_105835_V2.wsdl') {
...
//            $this->Security_SignOut();
     ...
     * @return object
     */
    public function getPnr($pnr, $id = \application\components\Amadeus\Utils::DEFAULT_AIRSOURCES_TEST_ID) {
...
class dataElementsIndiv {
    ...
    /**
     *
     * @var miscellaneousRemark $miscellaneousRemark
     * @access public
     */
